...
fun AddNomineeScreen(navController: NavHostController) {
    Column(modifier = Modifier.fillMaxSize(),
        ...
        Button(onClick = {
            ...
            nomineeRepository.saveNominee(nomineeName.text.trim(),
                nomineeEmail.text.trim(),
                nomineePost.text.trim(),0)
        ...
        ImagePicker(Modifier,context, navController, nomineeName.text.trim(), nomineeEmail.text.trim(), nomineePost.text.trim())


    }
}
@Composable
fun ImagePicker(modifier: Modifier = Modifier, context: Context, navController: NavHostController, name:String, email:String, post:String) {
